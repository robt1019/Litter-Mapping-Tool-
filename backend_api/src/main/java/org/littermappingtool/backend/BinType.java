...
public class BinType {
     ...
     * ===
     * Use the provided Builder to initialize a new BinType object.
	 */
	public BinType() {
	}
	...
	/**
	 * Instantiates a new bin type.
	 *
	 * @param builder the builder
	 */
	private BinType(Builder builder) {
