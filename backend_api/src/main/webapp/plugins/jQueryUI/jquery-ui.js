...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		closeText: "Vybrať mesiac", // Display text for close link
		prevText: "Predchádzajúci", // Display text for previous month link
		nextText: "Ďalší", // Display text for next month link
		currentText: "Tento mesiac", // Display text for current month link
		...
		dayNames: ["Nedeľa", "Pondelok", "Utorok", "Streda", "Štvrtok", "Piatok", "Sobota"], // For formatting
		dayNamesShort: ["Ned", "Pon", "Uto", "Str", "Štv", "Pia", "Sob"], // For formatting
		dayNamesMin: ["Ne","Po","Ut","St","Št","Pi","So"], // Column headings for days starting at Sunday
		weekHeader: "Týž.", // Column header for week of the year
